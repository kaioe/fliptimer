...
import {
	...
	setFliptimerSoundMuted,
	isFliptimerSoundMuted,
...
export function initFliptimerToolbar(clock, onAfterToolbarRefresh) {
	...
	function updateMuteIcon() {
		var muted = isFliptimerSoundMuted();
		$muteBtn.html(muted ? muteIconMuted : muteIconUnmuted);
		$muteBtn.attr("aria-label", muted ? "Unmute" : "Mute");
		$muteBtn.attr("title", muted ? "Unmute" : "Mute");
	}
	...
	$muteBtn.on("click", function () {
		setFliptimerSoundMuted(!isFliptimerSoundMuted());
		updateMuteIcon();
	});
